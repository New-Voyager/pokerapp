...
API_SERVER_IMAGE := $(REGISTRY)/api-server:0.7.78
GAME_SERVER_IMAGE := $(REGISTRY)/game-server:0.7.34
BOTRUNNER_IMAGE := $(REGISTRY)/botrunner:0.7.30
TIMER_IMAGE := $(REGISTRY)/timer:0.5.10
SCHEDULER_IMAGE := $(REGISTRY)/scheduler:0.1.8
