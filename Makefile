...
<<<<<<< HEAD
API_SERVER_IMAGE := $(REGISTRY)/api-server:0.2.14
GAME_SERVER_IMAGE := $(REGISTRY)/game-server:0.2.10
BOTRUNNER_IMAGE := $(REGISTRY)/botrunner:0.3.3
=======
API_SERVER_IMAGE := $(REGISTRY)/api-server:0.2.21
GAME_SERVER_IMAGE := $(REGISTRY)/game-server:0.2.13
BOTRUNNER_IMAGE := $(REGISTRY)/botrunner:0.3.8
>>>>>>> c2c36f3506fae0f6613a59e526e9d3800f394ce8
