...
class _RegistrationScreenNewState extends State<RegistrationScreenNew> {
  ...
  _checkLogin() async {
    ...
    final result = await AuthService.getPlayerInfo();
    if (result != null) {
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.of(context)
                                  .pushNamed(Routes.restore_account);
                            },
                            child: Container(
    ...
    if (_formKey.currentState.validate()) {
      ...
      if (resp['status']) {
        ...
        if (PlatformUtils.isWeb) {
          // if web, go to home
          Navigator.of(context)
              .pushNamedAndRemoveUntil(WebRoutes.home, (_) => false);
        } else {
          // if mobile, go to home
          Navigator.pushNamedAndRemoveUntil(
            context,
            Routes.main,
            (_) => false,
