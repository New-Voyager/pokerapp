...
import 'package:pokerapp/screens/main_screens/clubs_page_view/widgets/new_club_item.dart';
...
class _ClubsPageViewState extends State<ClubsPageView>
                          ...
                          : Expanded(
                              child: Padding(
                                padding: const EdgeInsets.only(
                                  top: AppDimensions.kMainPaddingHorizontal,
                                ),
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (_, index) {
                                    ...
                                    return getClubListItem(club, theme);
                                  },
  ...
  Widget getClubListItem(club, theme) {
    return InkWell(
      onTap: () {
