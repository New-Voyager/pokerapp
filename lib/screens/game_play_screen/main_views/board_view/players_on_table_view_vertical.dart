...
class PlayersOnTableViewNewVertical extends StatefulWidget {
  ...
  @override
  State<PlayersOnTableViewNewVertical> createState() =>
      _PlayersOnTableViewNewVerticalState();
}

class _PlayersOnTableViewNewVerticalState
    extends State<PlayersOnTableViewNewVertical> with TickerProviderStateMixin {
