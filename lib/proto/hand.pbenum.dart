...
class ACTION extends $pb.ProtobufEnum {
  static const ACTION ACTION_UNKNOWN = ACTION._(
      0,
...
class HandStatus extends $pb.ProtobufEnum {
  static const HandStatus HandStatus_UNKNOWN = HandStatus._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HandStatus_UNKNOWN');
  static const HandStatus DEAL = HandStatus._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DEAL');
  static const HandStatus PREFLOP = HandStatus._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PREFLOP');
  static const HandStatus FLOP = HandStatus._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLOP');
  static const HandStatus TURN = HandStatus._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TURN');
  static const HandStatus RIVER = HandStatus._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RIVER');
  static const HandStatus SHOW_DOWN = HandStatus._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SHOW_DOWN');
  static const HandStatus EVALUATE_HAND = HandStatus._(
      7,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'EVALUATE_HAND');
  static const HandStatus RESULT = HandStatus._(
      8,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RESULT');
  static const HandStatus HAND_CLOSED = HandStatus._(
      9,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HAND_CLOSED');
  ...
  static final $core.Map<$core.int, HandStatus> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class FlowState extends $pb.ProtobufEnum {
  static const FlowState FlowState_UNKNOWN = FlowState._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FlowState_UNKNOWN');
  static const FlowState DEAL_HAND = FlowState._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DEAL_HAND');
  static const FlowState WAIT_FOR_NEXT_ACTION = FlowState._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WAIT_FOR_NEXT_ACTION');
  static const FlowState PREPARE_NEXT_ACTION = FlowState._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PREPARE_NEXT_ACTION');
