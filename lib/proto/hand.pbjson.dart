...
final $typed_data.Uint8List aCTIONDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List handStatusDescriptor = $convert.base64Decode(
    'CgpIYW5kU3RhdHVzEhYKEkhhbmRTdGF0dXNfVU5LTk9XThAAEggKBERFQUwQARILCgdQUkVGTE9QEAISCAoERkxPUBADEggKBFRVUk4QBBIJCgVSSVZFUhAFEg0KCVNIT1dfRE9XThAGEhEKDUVWQUxVQVRFX0hBTkQQBxIKCgZSRVNVTFQQCBIPCgtIQU5EX0NMT1NFRBAJ');
...
final $typed_data.Uint8List flowStateDescriptor = $convert.base64Decode(
    'CglGbG93U3RhdGUSDQoJREVBTF9IQU5EEAASGAoUV0FJVF9GT1JfTkVYVF9BQ1RJT04QARIXChNQUkVQQVJFX05FWFRfQUNUSU9OEAISFQoRTU9WRV9UT19ORVhUX0hBTkQQAxIbChdXQUlUX0ZPUl9QRU5ESU5HX1VQREFURRAE');
...
final $typed_data.Uint8List handActionLogDescriptor = $convert.base64Decode(
    'Cg1IYW5kQWN0aW9uTG9nEhsKCXBvdF9zdGFydBgBIAEoAVIIcG90U3RhcnQSEgoEcG90cxgCIAMoAVIEcG90cxIqCgdhY3Rpb25zGAMgAygLMhAuZ2FtZS5IYW5kQWN0aW9uUgdhY3Rpb25zEjAKCnNlYXRzX3BvdHMYBCADKAsyES5nYW1lLlNlYXRzSW5Qb3RzUglzZWF0c1BvdHM=');
...
final $typed_data.Uint8List betRaiseOptionDescriptor = $convert.base64Decode(
    'Cg5CZXRSYWlzZU9wdGlvbhISCgR0ZXh0GAEgASgJUgR0ZXh0EhYKBmFtb3VudBgCIAEoAVIGYW1vdW50');
...
final $typed_data.Uint8List playerInSeatStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List playerBalanceDescriptor = $convert.base64Decode(
    'Cg1QbGF5ZXJCYWxhbmNlEhcKB3NlYXRfbm8YASABKA1SBnNlYXRObxIbCglwbGF5ZXJfaWQYAiABKARSCHBsYXllcklkEhgKB2JhbGFuY2UYAyABKAFSB2JhbGFuY2U=');
...
final $typed_data.Uint8List highHandDescriptor = $convert.base64Decode(
    'CghIaWdoSGFuZBIaCghnYW1lQ29kZRgBIAEoCVIIZ2FtZUNvZGUSGQoIaGFuZF9udW0YAiABKA1SB2hhbmROdW0SLgoHd2lubmVycxgDIAMoCzIULmdhbWUuSGlnaEhhbmRXaW5uZXJSB3dpbm5lcnM=');
...
final $typed_data.Uint8List playerActRoundDescriptor = $convert.base64Decode(
    'Cg5QbGF5ZXJBY3RSb3VuZBIkCgZhY3Rpb24YASABKA4yDC5nYW1lLkFDVElPTlIGYWN0aW9uEhYKBmFtb3VudBgCIAEoAVIGYW1vdW50EiAKC3JhaXNlQW1vdW50GAMgASgBUgtyYWlzZUFtb3VudBImCg9hY3RlZF9iZXRfaW5kZXgYBCABKA1SDWFjdGVkQmV0SW5kZXgSHQoKYmV0X2Ftb3VudBgFIAEoAVIJYmV0QW1vdW50');
...
final $typed_data.Uint8List seatsInPotsDescriptor = $convert.base64Decode(
    'CgtTZWF0c0luUG90cxIUCgVzZWF0cxgBIAMoDVIFc2VhdHMSEAoDcG90GAIgASgBUgNwb3Q=');
...
final $typed_data.Uint8List seatBettingDescriptor = $convert
    .base64Decode('CgtTZWF0QmV0dGluZxIZCghzZWF0X2JldBgBIAMoAVIHc2VhdEJldA==');
...
const RoundState$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.game.RoundState.PlayerBalanceEntry',
      '10': 'playerBalance'
    },
...
final $typed_data.Uint8List roundStateDescriptor = $convert.base64Decode(
    '');
...
const CurrentHandState$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.game.CurrentHandState.PlayersActedEntry',
      '10': 'playersActed'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.game.CurrentHandState.PlayersStackEntry',
      '10': 'playersStack'
    },
    const {
      '1': 'next_seat_to_act',
    ...
    const {
      '1': 'remaining_action_time',
      '3': 21,
      '4': 1,
      '5': 13,
      '10': 'remainingActionTime'
    },
    const {
      '1': 'next_seat_action',
      '3': 22,
  ...
  '3': const [
    ...
    CurrentHandState_PlayersStackEntry$json
  ],
};
...
final $typed_data.Uint8List currentHandStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List handWinnerDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List potWinnersDescriptor = $convert.base64Decode(
    'CgpQb3RXaW5uZXJzEhUKBnBvdF9ubxgBIAEoDVIFcG90Tm8SFgoGYW1vdW50GAIgASgBUgZhbW91bnQSLwoKaGlfd2lubmVycxgDIAMoCzIQLmdhbWUuSGFuZFdpbm5lclIJaGlXaW5uZXJzEjEKC2xvd193aW5uZXJzGAQgAygLMhAuZ2FtZS5IYW5kV2lubmVyUgpsb3dXaW5uZXJzEh0KCnBhdXNlX3RpbWUYBSABKA1SCXBhdXNlVGltZQ==');
...
final $typed_data.Uint8List boardCardRankDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List winnerDescriptor = $convert.base64Decode(
    'CgZXaW5uZXISFwoHc2VhdF9ubxgBIAEoDVIGc2VhdE5vEhYKBmFtb3VudBgCIAEoAVIGYW1vdW50');
...
final $typed_data.Uint8List potWinnersV2Descriptor = $convert.base64Decode(
    'CgxQb3RXaW5uZXJzVjISFQoGcG90X25vGAEgASgNUgVwb3RObxIWCgZhbW91bnQYAiABKAFSBmFtb3VudBI2Cg1ib2FyZF93aW5uZXJzGAMgAygLMhEuZ2FtZS5Cb2FyZFdpbm5lclIMYm9hcmRXaW5uZXJzEiIKDXNlYXRzX2luX3BvdHMYBCADKA1SC3NlYXRzSW5Qb3Rz');
...
final $typed_data.Uint8List handPlayerBalanceDescriptor = $convert.base64Decode(
    'ChFIYW5kUGxheWVyQmFsYW5jZRIWCgZiZWZvcmUYASABKAFSBmJlZm9yZRIUCgVhZnRlchgCIAEoAVIFYWZ0ZXI=');
...
final $typed_data.Uint8List playerHandInfoDescriptor = $convert.base64Decode(
    '');
