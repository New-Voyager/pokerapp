...
final $typed_data.Uint8List handActionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List extendTimerDescriptor = $convert.base64Decode('CgtFeHRlbmRUaW1lchIXCgdzZWF0X25vGAEgASgNUgZzZWF0Tm8SIgoNZXh0ZW5kX2J5X3NlYxgCIAEoDVILZXh0ZW5kQnlTZWMSIwoNcmVtYWluaW5nX3NlYxgDIAEoDVIMcmVtYWluaW5nU2Vj');
...
final $typed_data.Uint8List resetTimerDescriptor = $convert.base64Decode('CgpSZXNldFRpbWVyEhcKB3NlYXRfbm8YASABKA1SBnNlYXRObxIjCg1yZW1haW5pbmdfc2VjGAIgASgNUgxyZW1haW5pbmdTZWM=');
...
final $typed_data.Uint8List nextSeatActionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List playerHandInfoDescriptor = $convert.base64Decode('');
