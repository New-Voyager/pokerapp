...
final $typed_data.Uint8List flowStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List betRaiseOptionDescriptor = $convert.base64Decode(
    'Cg5CZXRSYWlzZU9wdGlvbhISCgR0ZXh0GAEgASgJUgR0ZXh0EhYKBmFtb3VudBgCIAEoAlIGYW1vdW50');
...
final $typed_data.Uint8List nextSeatActionDescriptor = $convert.base64Decode(
    '');
...
const PlayerInSeatState$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uuid', '3': 13, '4': 1, '5': 9, '10': 'uuid'},
  ],
};
...
final $typed_data.Uint8List playerInSeatStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List playerBalanceDescriptor = $convert.base64Decode(
    'Cg1QbGF5ZXJCYWxhbmNlEhcKB3NlYXRfbm8YASABKA1SBnNlYXRObxIbCglwbGF5ZXJfaWQYAiABKARSCHBsYXllcklkEhgKB2JhbGFuY2UYAyABKAJSB2JhbGFuY2U=');
...
final $typed_data.Uint8List playerActRoundDescriptor = $convert.base64Decode(
    'Cg5QbGF5ZXJBY3RSb3VuZBIqCgVzdGF0ZRgBIAEoDjIULmdhbWUuUGxheWVyQWN0U3RhdGVSBXN0YXRlEhYKBmFtb3VudBgCIAEoAlIGYW1vdW50EiAKC3JhaXNlQW1vdW50GAMgASgCUgtyYWlzZUFtb3VudBImCg9hY3RlZF9iZXRfaW5kZXgYBCABKA1SDWFjdGVkQmV0SW5kZXgSHQoKYmV0X2Ftb3VudBgFIAEoAlIJYmV0QW1vdW50');
...
final $typed_data.Uint8List seatsInPotsDescriptor = $convert.base64Decode(
    'CgtTZWF0c0luUG90cxIUCgVzZWF0cxgBIAMoDVIFc2VhdHMSEAoDcG90GAIgASgCUgNwb3Q=');
...
final $typed_data.Uint8List seatBettingDescriptor = $convert
    .base64Decode('CgtTZWF0QmV0dGluZxIZCghzZWF0X2JldBgBIAMoAlIHc2VhdEJldA==');
...
final $typed_data.Uint8List roundStateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List handWinnerDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List potWinnersV2Descriptor = $convert.base64Decode(
    'CgxQb3RXaW5uZXJzVjISFQoGcG90X25vGAEgASgNUgVwb3RObxIWCgZhbW91bnQYAiABKAJSBmFtb3VudBI2Cg1ib2FyZF93aW5uZXJzGAMgAygLMhEuZ2FtZS5Cb2FyZFdpbm5lclIMYm9hcmRXaW5uZXJzEiIKDXNlYXRzX2luX3BvdHMYBCADKA1SC3NlYXRzSW5Qb3Rz');
